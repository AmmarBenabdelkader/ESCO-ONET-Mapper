...
?>
        <table align="left" class="stap" cellpadding="0" cellspacing="0" width=400 border=0>
          <tbody>
            <tr>
		<td align=center class="tekst_gwn"><br><font size=+1><b>&nbsp;&nbsp;&nbsp;ESCO Preferred Labels <br>&nbsp;</b></font>(to be mapped)<?php echo $_GET["keyword"] ?> </td></tr>
		<tr><td align=center class="tekst_gwn">
<form action=content.php method=post target=content>
<?php echo (strlen($keyword)>0?"keyword: '" . $keyword . "'<br>":""); ?>
...
<br>&nbsp; <br>
 <b>Weight for the different scores:</b> <font size=-1><br>
 &nbsp;Rule 1 (Score_A): <input type="text" name="r1_score_a" value=100 size=2 style="color:grey;"><br>
 &nbsp;Rule 2 (Score_A): <input type="text" name="r2_score_a" value=100 size=2 style="color:grey;"><br>
 &nbsp;Rule 3 (Score_A): <input type="text" name="r3_score_a" value=75 size=2 style="color:grey;"><br>
 &nbsp;Rule 4 (Score_A): <input type="text" name="r4_score_a" value=100 size=2 style="color:grey;"><br>
 &nbsp;Rule 5 (Score_A): <input type="text" name="r5_score_a" value=100 size=2 style="color:grey;"><br>&nbsp;
</font>
</td></tr>
</table>
</form>
...
<table align="left" class="stap" cellpadding="0" cellspacing="0" width=400 border=0>
  <tbody>
    <tr>
	<td align=center class="tekst_gwn"><br><font size=+1><br>&nbsp;<b>&nbsp;&nbsp;&nbsp;ESCO Preferred Labels <br>&nbsp;</b></font>(mapped to O*NET)<br>&nbsp;</td></tr>
    <tr>
	<td align=left class="tekst_gwn"> <form action=content.php method=post target=content>
		&nbsp;<select name=occupation id="wgtmsr">
		<option value="">Select Preferred Label</option>
<?php
$servername = "localhost";
...
$sql = "select distinct esco_code, esco_pt from onet_22_2.ESCO_ONET_mapping order by esco_pt";
$result = $conn->query($sql);
